...
Upgraded: always reads config.SYSTEM_PROMPT at call time so the
snapshot-enriched prompt is always used after startup.
"""
...
class AIBrain:
    ...
    def _current_system_prompt(self) -> str:
        """Always pull the live system prompt (snapshot may have updated it)."""
